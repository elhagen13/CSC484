...
function ProfilePhoto(){
    ...
    <div style={{width: '100%', height: 150, paddingLeft: 31, paddingRight: 31, paddingTop: 8, paddingBottom: 8, background: '#FFF5D0', justifyContent: 'space-between', alignItems: 'center', display: 'inline-flex'}}>
