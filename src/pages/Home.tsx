                ...
                {category.type.map((eventType) => {
                  return (
                    <div style={{marginTop:'50px'}}>
                      <p style={{
                        fontFamily: 'inter', fontWeight: 'bolder', fontSize: '20px',
                        width: '100%', color: 'black', textAlign: 'left' }}>
                        {eventType.eventName}
                      </p>
                      
                      <div style={{
                        display: 'flex', flexDirection: 'row', gap: '40px',
                        width: '100%', transform: "translate(-12px, 0%)", overflowX: 'scroll',
                        padding: '10px'
                      }}>
                        {eventType.events.map((event, index) => (
                          <div key={index} style={{position: 'relative',
                            width: '225px', height: '225px', backgroundColor: 'white', flexShrink: 0,
                            boxShadow: '0px 0px 6px rgba(0, 0, 0, 0.2)', borderRadius: '20px',
                            alignContent: 'center', padding: '0px 30px'}}>
                            <p style={{
                              fontFamily: 'inter', fontSize: '12px', width: '100%',
                              color: '#B2B2B2'}}>
                              {event.date}, {event.time}
                            </p>
                            <p style={{
                              fontFamily: 'inter', fontWeight: 'bolder', fontSize: '15px',
                            ...
                            <div style={{
                              ...
                              <MapPin color='#B2B2B2' height='14px' />
                              <p style={{fontFamily: 'inter', fontSize: '12px',
                                width: '100%', color: '#B2B2B2'}}>
                                {event.location}
                              </p>
                            </div>
